...
class CashCardApplicationTests {
    ...
    void shouldCreateANewCashCard(){
        ...
        //Verifica se um novo cartao foi criado usando a resposta 201
        ...
        //verifica se apos o cartao ser criado sua localizacao esta em status ok
    ...
    void shouldReturnASortedPageOfCashCards() {
        //Essa URI possui tanto a informação da pagina quanto do seu tamanho e ainda esta ordenando os valores 'amout'
        ...
        //verificamos se a pagina existe
        assertThat(response.getStatusCode()).isEqualTo(HttpStatus.OK);
        ...
        //aqui estamos esperando que o primeiro valor do request sera 150, o maior dos valores adicionados
    ...
    void shouldReturnASortedPageOfCashCardsWithNoParametersAndUseDefaultValues() {
        ...
        DocumentContext documentContext = JsonPath.parse(response.getBody());
        JSONArray page = documentContext.read("$[*]");
        //quero garantir que estamos guardadno 3 dados
        assertThat(page.size()).isEqualTo(3);

        JSONArray amounts = documentContext.read("$..amount");
        //queremos arantir que os dados estao sendo salvos de forma ascendente
        assertThat(amounts).containsExactly(1.00, 123.45, 150.00);
    }

    @Test
    void shouldNotReturnACashCardWhenUsingBadCredentials(){
        ResponseEntity<String> response = restTemplate.withBasicAuth("badUser", "abc123").getForEntity("/cashcards/99", String.class);
        assertThat(response.getStatusCode()).isEqualTo(HttpStatus.UNAUTHORIZED);

        response = restTemplate.withBasicAuth("sarah1", "badPassword").getForEntity("/cashcards/99", String.class);
        assertThat(response.getStatusCode()).isEqualTo(HttpStatus.UNAUTHORIZED);
    }
